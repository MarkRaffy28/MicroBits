...
function UserNavigation() {
  ...
  const CartButton = ({ className }) => (
    <button onClick={() => navigate("/user/cart")} className={className}>
  ...
  const VerifiedBadge = () => emailVerified ? (
    <span title="Email verified" className="flex items-center gap-1 text-xs text-green-400">
    ...
    <span
      ...
      className="flex items-center gap-1 text-xs text-yellow-400 cursor-pointer hover:text-yellow-300 transition-colors">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden w-full ml-8 md:flex justify-between items-center gap-8">
            <div className="flex items-center gap-4">
              {navItems.map((item) => (
                <NavLink key={item.path} to={item.path}
                  ...
                  {item.label}
                  <span className={getUnderlineClasses(item.path)} />
                </NavLink>
              ))}
            </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <CartButton className="relative bg-white/10 hover:bg-white/20 text-white p-[6px] rounded-lg transition-all duration-200" />
          ...
          {/* Mobile — cart + burger */}
          <div className="flex items-center gap-4">
            <CartButton className="md:hidden relative bg-white/10 hover:bg-white/20 text-white p-[6px] rounded-lg transition-all duration-200" />
