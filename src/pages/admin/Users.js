  ...
  const userRows = displayedUsers.map((user) => (
    <>
      ...
      <td className="text-center px-3 py-3 whitespace-nowrap">
        <button className="bg-blue-500 hover:bg-blue-600 text-white text-sm px-3 py-1.5 rounded mr-1 transition-all duration-200 transform hover:scale-105"
          onClick={(e) => { e.stopPropagation(); handleViewShow(user); }}>
          <i className="bi bi-eye mr-1" />View
        </button>
        <button className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 text-sm px-3 py-1.5 rounded mr-1 transition-all duration-200 transform hover:scale-105 disabled:opacity-40 disabled:cursor-not-allowed disabled:transform-none"
              ...
              <form onSubmit={addUser}>
                ...
                <div className="pt-2 flex justify-center gap-3">
                  ...
                  <button type="submit" disabled={isAdding}
                    ...
                    {isAdding ? <><Spinner /> Adding...</> : "Add User"}
                  </button>
                </div>
              </form>
            </div>
              ...
              <form onSubmit={editUser}>
                ...
                <div className="pt-2 flex justify-center gap-3">
                  ...
                  <button type="submit" disabled={isEditing}
                    className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center gap-2">
                    {isEditing ? <><Spinner /> Saving...</> : "Save Changes"}
                  </button>
                </div>
              </form>
            </div>
